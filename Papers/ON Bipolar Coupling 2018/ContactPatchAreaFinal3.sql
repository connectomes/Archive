...
select SourceParent.ID as SourceCellID, SourceParent.Label as SourceCellLabel, SL.SourceID as SourceID, SourceType.ID as SourceTypeID, SourceType.Name as SourceType, Source.Confidence as SourceConfidence, dbo.ufnStructureArea(SL.SourceID) as SourceArea_nm,  dbo.ufnStructureArea(SL.SourceID) / 1000000.0 as SourceArea_um,

          TargetParent.ID as TargetCellID, TargetParent.Label as TargetCellLabel, SL.TargetID as TargetID, TargetType.ID as TargetTypeID, TargetType.Name as TargetType, Target.Confidence as TargetConfidence, dbo.ufnStructureArea(SL.TargetID) as TargetArea_nm,  dbo.ufnStructureArea(SL.TargetID) / 1000000.0 as TargetArea_um
